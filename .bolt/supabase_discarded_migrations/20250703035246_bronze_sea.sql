/*
  ...
  1. New Tables
    - `user_plans`: Links users to their subscription plans
  ...
  2. Security
    ...
    - Add policies for users to view/update their own plans
    - Service role can manage all plans (for webhooks)
  ...
  5. Views
    - `user_plan_details`: Comprehensive view with subscription data
*/
